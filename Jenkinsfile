    ...
    stages {
        ...
        stage ('5. Email Notification') {
            steps {
              ...
              +1 (313) 413-1477''', cc: 'akingab@gmail.com' 'adewalegg@yahoo.com' 'bajogab@gmail.com', from: '', replyTo: '', subject: 'Terraform Infra deployment completed!!!', to: 'fusisoft@gmail.com'
